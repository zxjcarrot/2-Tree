...
public:
    ...
    /// Typedef of our own type
    typedef compressed_btree_map<key_type, data_type, key_compare, traits, allocator_type> self_type;
    ...
    /// Implementation type of the btree_base
    typedef stx::compressed_btree<key_type, data_type, value_type, key_compare,
                       traits, false, allocator_type, false> btree_impl;
...
public:
    ...
    /// Default constructor initializing an empty B+ tree with the standard key
    /// comparison function
    explicit inline compressed_btree_map(const allocator_type& alloc = allocator_type())
        : tree(alloc)
    { }

    /// Constructor initializing an empty B+ tree with a special key
    /// comparison object
    explicit inline compressed_btree_map(const key_compare& kcf,
                              const allocator_type& alloc = allocator_type())
        : tree(kcf, alloc)
    { }
    ...
    /// Constructor initializing a B+ tree with the range [first,last)
    template <class InputIterator>
    inline compressed_btree_map(InputIterator first, InputIterator last,
                     const allocator_type& alloc = allocator_type())
        : tree(first, last, alloc)
    { }
    ...
    /// special key comparison object
    template <class InputIterator>
    inline compressed_btree_map(InputIterator first, InputIterator last, const key_compare& kcf,
                     const allocator_type& alloc = allocator_type())
        : tree(first, last, kcf, alloc)
    { }

    /// Frees up all used B+ tree memory pages
    inline ~compressed_btree_map()
    { }
...
public:
    ...
    /// Copy constructor. The newly initialized B+ tree object will contain a
    /// copy of all key/data pairs.
    inline compressed_btree_map(const compressed_btree_map& other)
        : tree(other.tree)
    { }
