...
class BTreeLL : public BTreeInterface, public BTreeGeneric
{
  public:
   ...
   virtual OP_RESULT lookup(u8* key, u16 key_length, function<void(const u8*, u16)> payload_callback, bool & mark_dirty) override;
   ...
   virtual OP_RESULT insert_might_fail(u8* key, u16 key_length, u8* value, u16 value_length) override;
