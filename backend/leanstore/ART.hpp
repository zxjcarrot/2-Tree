...
public:
    ...
    ART(std::size_t key_length);
    ART(std::size_t key_length, std::function<void(uintptr_t,uint8_t*)> loadKey);
    ART(std::size_t key_length, std::function<void(uintptr_t,uint8_t*)> loadKey, std::function<void(Node**, uintptr_t)> upsertFunc);
