...
build/frontend/ycsb_zipf --trunc=1 --ycsb_tuple_count=10000000 --dram_gib=0.3 --worker_threads=1 --index_type=2BTree  --cached_btree_ram_ratio=0.9 --ycsb_read_ratio=100 --ssd_path=/mnt/disks/nvme/leanstore --run_for_seconds=480 --ycsb_request_dist=hotspot --ycsb_request_hotspot_keyspace_fraction=0.2  --ycsb_request_hotspot_op_fraction=1 --zipf_factor=0 --inclusive_cache --cache_lazy_migration=50 --xmerge
...
build/frontend/ycsb_zipf --trunc=1 --ycsb_tuple_count=10000000 --dram_gib=0.3 --worker_threads=1 --index_type=2LSMT-CF  --cached_btree_ram_ratio=0.9 --ycsb_read_ratio=100 --ssd_path=/mnt/disks/nvme/leanstore --run_for_seconds=480 --ycsb_request_dist=hotspot --ycsb_request_hotspot_keyspace_fraction=0.1  --ycsb_request_hotspot_op_fraction=1 --zipf_factor=0 --xmerge >> $log_file 2>&1
