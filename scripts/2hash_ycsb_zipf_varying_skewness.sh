...
log_file="${RESULT_DIR_PREFIX}/2hash_ycsb_zipf_dram_skewness.log"
# empty log file
...
do
csv_file="${RESULT_DIR_PREFIX}/2hash_ycsb_zipf_dram_read_ratio_${read_ratio}_skewness_${zipf_factor}.csv"
