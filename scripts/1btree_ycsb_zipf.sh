...
# do
# run_time=$RUNTIME
# log_file="${RESULT_DIR_PREFIX}/1btree_ycsb_zipf_dram_${dram_budget}.log"
# # empty log file
# cat /dev/null > $log_file
# for read_ratio in 100 50
# do
# update_ratio=$((100-read_ratio))
# csv_file="${RESULT_DIR_PREFIX}/1btree_ycsb_zipf_dram_${dram_budget}_read_ratio_${read_ratio}.csv"
...
log_file="${RESULT_DIR_PREFIX}/treeline_ycsb_zipf_dram_${dram_budget}.log"
# empty log file
cat /dev/null > $log_file
for read_ratio in 100 50
do
update_ratio=$((100-read_ratio))
csv_file="${RESULT_DIR_PREFIX}/treeline_ycsb_zipf_dram_${dram_budget}_read_ratio_${read_ratio}.csv"
for zipf_factor in 0.9
do
