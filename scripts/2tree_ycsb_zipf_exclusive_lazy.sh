...
do
run_time=600
log_file="2lsmt_ycsb_zipf_dram_${dram_budget}gib_exclusive_lazy.log"
# empty log file
...
# do
# run_time=300
# log_file="trie_lsmt_ycsb_zipf_dram_${dram_budget}gib_exclusive_lazy.log"
# # empty log file
# cat /dev/null > $log_file
# for read_ratio in 100 0
# do
...
# do
# run_time=300
# log_file="im2btree_ycsb_zipf_dram_${dram_budget}gib_exclusive_lazy.log"
# # empty log file
# cat /dev/null > $log_file
# for read_ratio in 100 0
# do
...
do
run_time=300
log_file="2btree_ycsb_zipf_dram_${dram_budget}gib_exclusive_lazy.log"
# empty log file
cat /dev/null > $log_file
for read_ratio in 100 0
do
...
# do
# run_time=300
# log_file="trie_btree_ycsb_zipf_dram_${dram_budget}gib_exclusive_lazy.log"
# # empty log file
# cat /dev/null > $log_file
# for read_ratio in 100 0
# do
